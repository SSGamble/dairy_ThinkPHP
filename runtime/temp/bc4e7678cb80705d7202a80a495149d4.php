<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/var/www/html/daily/application/admin/view/note/notelst.html";i:1542591609;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
      <meta charset="utf-8">
...
<!--             <button type="button" class="btn btn-default">
                <a href="<?php echo url('note/exportDatabase'); ?>">
                    <span class="glyphicon glyphicon-floppy-disk"></span> 备份数据库
                </a>
            </button>
            <button type="button" class="btn btn-default">
                <a onclick="isHide()">
                    <span class="glyphicon glyphicon-eye-close"></span> 隐藏标题
                </a>
            </button> -->
            <span id="note_count">
                <button type="button" class="btn btn-default">
            ...
            <ul class="topnav" style="width: 100%;margin: 0px;">
                <li><a href="#">CS</a>
                    <ul style="overflow: hidden; display: block;"> <!--标签默认打开-->
                        ...
                        <li><a onclick="aShowNote2('<?php echo $vl['groups']; ?>');"><?php echo $vl['groups']; ?>（<?php echo $vl['g_count']; ?>）</a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </li>
            </ul>
