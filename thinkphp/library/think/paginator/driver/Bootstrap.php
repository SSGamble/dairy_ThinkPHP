...
class Bootstrap extends Paginator
{
     ...
     * @return string
     */
    protected function getPreviousButton($text = "Pre")
    {
    ...
    {
        return '<li><a class="page-link" href="' . htmlentities($url) . '">' . $page . '</a></li>';
    }
    ...
    {
        return '<li class="disabled"><a class="page-link"><span>' . $text . '</span></a></li>';
    }
    ...
    {
        return '<li class="active"><a class="page-link"><span>' . $text . '</span></a></li>';
    }
